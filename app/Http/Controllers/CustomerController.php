...
class CustomerController extends AppBaseController
{
     ...
     * @return Response
     */
    public function show($id, \App\DataTables\ContactDataTable $dataTable)
    {
        $customer = $this->customerRepository->findWithoutFail($id);
        
        $res = $dataTable->html("/api/customers/$customer->id/contacts");
        ...
        return view('customers.show')->with(['customer' => $customer, 'dataTable' => $res]);
    }
